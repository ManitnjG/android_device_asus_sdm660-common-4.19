...
BOARD_CACHEIMAGE_PARTITION_SIZE := 367001600  # 350 MB (adjusted for 32 GB internal storage)
BOARD_RECOVERYIMAGE_PARTITION_SIZE := 67108864 # 64 MB
BOARD_SYSTEMIMAGE_PARTITION_SIZE := 5368709120 # 5 GB (adjusted to 5 GB)
BOARD_USERDATAIMAGE_PARTITION_SIZE := 16106127360 # 15 GB
BOARD_VENDORIMAGE_PARTITION_SIZE := 859384339  # Adjusted to the specified vendor.img size
